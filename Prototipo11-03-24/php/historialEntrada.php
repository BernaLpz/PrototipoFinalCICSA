...
// Consulta para obtener los últimos 10 registros del historial de entradas
$sql = "SELECT * FROM entradas ORDER BY Fecha DESC, Hora DESC LIMIT 10";
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><td colspan='5'>No se encontraron registros de entrada.</td></tr>";
}
} else {
    // Si ocurre un error en la consulta, mostrar un mensaje de error
    echo "<tr><td colspan='5'>Error al obtener los registros de entrada.</td></tr>";
}
