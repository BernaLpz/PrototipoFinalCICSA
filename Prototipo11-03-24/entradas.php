...
<head>
    ...
    <title>Registro de Entradas de Herramientas</title>
...
<body>
    <header class="bg-dark text-white py-4">
        <div class="container">
            <h1 class="text-center">Registro de Entradas de Herramientas</h1>
    ...
    <main class="mt-4">
    <div class="container">
        <!-- Formulario para registrar la entrada de una herramienta -->
        <h2 class="mb-4">Registrar Entrada de Herramienta
                <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEntradaHerramientas" aria-expanded="false" aria-controls="collapseEntradaHerramientas">
        ...
        <div class="collapse" id="collapseEntradaHerramientas">
        <form action="php/procesar_entrada.php" method="POST" class="mb-4">
        <div class="mb-3">
    ...
    <script>
        ...
        <h2 class="mt-4">Historial de Entradas <a href="historialEntradaPag.php" class="btn btn-primary">Ver Historial Completo</a></h2>
        ...
        <div class ="table-responsive">
            <table class="table">
                ...
                <tbody id="historialEntradas">

                    <?php include 'php/historialEntrada.php'; ?>
                </tbody>
            </table>
        </div>
    </main>
