...
<head>
    ...
    <title>Historial de Entradas de Herramientas</title>
...
<body>
    <header class="bg-dark text-white py-4">
        <div class="container">
            <h1 class="text-center">Historial de Entradas de Herramientas</h1>
            <a href="entradas.php" class="btn btn-light">Volver a Entradas</a>
        </div>
    </header>
    ...
    <main class="mt-4">
        <div class="container">
            ...
            <h2 class="mt-4">Historial de Entradas
                ...
                function filtrarHistorial() {
                    ...
                    xhr.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            document.getElementById("historialEntradas").innerHTML = this.responseText;
                        }
                    };
                    xhr.open("POST", "php/filtrarHistorialEntrada.php", true);
